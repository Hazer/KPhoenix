...
class NVWebSocket(endpoint: String, override var timeout: Long) : WebSocket(endpoint) {
    ...
    val ws = factory.createSocket(endpoint, timeout.toInt())
    ...
    companion object Factory : TransportFactory {
        ...
        override fun invoke(endPoint: String, longpollerTimeout: Long): NVWebSocket = NVWebSocket(endPoint, longpollerTimeout)
    }
}
